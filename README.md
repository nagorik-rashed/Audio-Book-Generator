...
- ElevenLabs API key for text-to-speech generation (obtainable from elevenlabs.io)
- Google Sheets OAuth2 credentials for reading chapter content
- Google Drive OAuth2 credentials for storing audio files
